    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 animate-fade-in">
            <div className="max-w-md w-full text-center">
                <Logo />
                <p className="mt-2 text-lg text-gray-400">Create Your Secure Production Workspace</p>
            </div>
            ...
            <div className="max-w-sm w-full mt-10 bg-gray-800/50 border border-gray-700/50 rounded-xl shadow-2xl shadow-indigo-900/20 p-8">
                <h2 className="text-2xl font-bold text-center text-gray-200">Create an Account</h2>
                ...
                <form onSubmit={handleSignUp} className="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            id="email-signup" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required autoComplete="email"
                            className="mt-1 block w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-md text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        />
                    </div>
                    <div>
                        ...
                        <input
                             id="password-signup" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required autoComplete="new-password"
                             className="mt-1 block w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-md text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        />
                    </div>
                    <button
